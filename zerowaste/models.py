...
class Report(models.Model):
    ...
    zone_name = models.CharField(max_length=100, default = "staff Hostel")
    kitchen_waste_in_kg = models.FloatField(db_column='kitchen waste in kg', blank=True, null=True)  # Field renamed to remove unsuitable characters.
    burnable_waste_in_kg = models.FloatField(db_column='burnable waste in kg', blank=True, null=True)  # Field renamed to remove unsuitable characters.
    landfill_inside_house = models.FloatField(db_column='landfill inside house', blank=True, null=True)  # Field renamed to remove unsuitable characters.
    ...
    recyclable_waste = models.FloatField(db_column='recyclable waste', blank=True, null=True)  # Field renamed to remove unsuitable characters.
